...
const AddBlog = () => {
  ...
  const generateContent = async () => {
    if (!title) return toast.error('Başlık Giriniz') 
      try {
        setLoading(true);
  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <p className="mt-4">Blog Başlığı</p>
        <input
          type="text"
        ...
        <p className="mt-4">Blog Açıklaması</p>
        ...
        <p className="mt-4">Blog Kategori</p>
